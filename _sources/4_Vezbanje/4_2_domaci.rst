...
.. infonote::
        ...
        Медијана је вредност на средини низа свих донација. 
        
        На пример, ако је низ [1, 2, 3, 4, 5], медијана је 3 зато што је 3 на средини низа.
        
        Ако је низ [1, 2, 3, 4, 5, 6], медијана је 3.5 зато што је просек бројева 3 и 4. 

        Ако је низ [1, 2, 8, 9, 10], медијана је 8 зато што је 8 на средини низа.
...
Задатак за размишлјанје: Прикупљање донација
`````````````````````````````````
