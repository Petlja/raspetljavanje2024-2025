...
Напиши програм који проверава да ли је дата квадратна матрица идентичетска.  KOMENTAR: /каква је то матрица? Идентична матрица? Не може се изгуглати?/
**Идентичетска матрица** има све елементе на дијагонали једнаке 1, а остале 0. KOMENTAR: /као горе/
